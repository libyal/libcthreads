...
#if defined( HAVE_CTHREADS_TEST_FUNCTION_HOOK ) && defined( HAVE_PTHREAD_RWLOCK_UNLOCK_HOOK )
...
#endif /* defined( HAVE_CTHREADS_TEST_FUNCTION_HOOK) && defined( HAVE_PTHREAD_RWLOCK_UNLOCK_HOOK ) */
