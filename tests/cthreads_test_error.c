...
/* Tests the libcthreads_error_free function
 * Returns 1 if successful or 0 if not
 */
int cthreads_test_error_free(
     void )
{
...
/* Tests the libcthreads_error_fprint function
 * Returns 1 if successful or 0 if not
 */
int cthreads_test_error_fprint(
     void )
{
	/* Test invocation of function only
	 */
...
/* Tests the libcthreads_error_sprint function
 * Returns 1 if successful or 0 if not
 */
int cthreads_test_error_sprint(
     void )
{
	/* Test invocation of function only
	 */
...
/* Tests the libcthreads_error_backtrace_fprint function
 * Returns 1 if successful or 0 if not
 */
int cthreads_test_error_backtrace_fprint(
     void )
{
	/* Test invocation of function only
	 */
...
/* Tests the libcthreads_error_backtrace_sprint function
 * Returns 1 if successful or 0 if not
 */
int cthreads_test_error_backtrace_sprint(
     void )
{
	/* Test invocation of function only
	 */
