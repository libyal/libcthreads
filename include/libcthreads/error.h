/*
 * The error code definitions for libcthreads
 *
...
#if !defined( _LIBCTHREADS_ERROR_H )
#define _LIBCTHREADS_ERROR_H

#include <libcthreads/types.h>

/* External error type definition hides internal structure
 */
typedef intptr_t libcthreads_error_t;
 ...
 */
enum LIBCTHREADS_ARGUMENT_ERROR
{
	LIBCTHREADS_ARGUMENT_ERROR_GENERIC			= 0,

	/* The argument contains an invalid value
	 */
	LIBCTHREADS_ARGUMENT_ERROR_INVALID_VALUE		= 1,
	 ...
	 */
	LIBCTHREADS_ARGUMENT_ERROR_VALUE_EXCEEDS_MAXIMUM	= 4,

	/* The argument contains a value that is too small
	 */
	LIBCTHREADS_ARGUMENT_ERROR_VALUE_TOO_SMALL		= 5,

	/* The argument contains a value that is too large
	 */
	LIBCTHREADS_ARGUMENT_ERROR_VALUE_TOO_LARGE		= 6,
...
enum LIBCTHREADS_CONVERSION_ERROR
{
	 ...
	 */
	LIBCTHREADS_CONVERSION_ERROR_INPUT_FAILED		= 1,

	/* The conversion failed on the output
	 */
	LIBCTHREADS_CONVERSION_ERROR_OUTPUT_FAILED		= 2
};
...
enum LIBCTHREADS_IO_ERROR
{
	...
	/* The open failed
	 */
	LIBCTHREADS_IO_ERROR_OPEN_FAILED			= 1,

	/* The close failed
	 */
	LIBCTHREADS_IO_ERROR_CLOSE_FAILED			= 2,

	/* The seek failed
	 */
	LIBCTHREADS_IO_ERROR_SEEK_FAILED			= 3,

	/* The read failed
	 */
	LIBCTHREADS_IO_ERROR_READ_FAILED			= 4,

	/* The write failed
	 */
	LIBCTHREADS_IO_ERROR_WRITE_FAILED			= 5,

	/* Access denied
	 */
	LIBCTHREADS_IO_ERROR_ACCESS_DENIED			= 6,
	...
	/* The ioctl failed
	 */
	LIBCTHREADS_IO_ERROR_IOCTL_FAILED			= 8,

	/* The unlink failed
	 */
	LIBCTHREADS_IO_ERROR_UNLINK_FAILED			= 9
};
...
enum LIBCTHREADS_INPUT_ERROR
{
	 ...
	 */
	LIBCTHREADS_INPUT_ERROR_SIGNATURE_MISMATCH		= 2,

	/* A checksum in the input did not match
	 */
	LIBCTHREADS_INPUT_ERROR_CHECKSUM_MISMATCH		= 3,
 ...
 */
enum LIBCTHREADS_MEMORY_ERROR
{
	LIBCTHREADS_MEMORY_ERROR_GENERIC			= 0,
 ...
 */
enum LIBCTHREADS_OUTPUT_ERROR
{
	LIBCTHREADS_OUTPUT_ERROR_GENERIC			= 0,
 ...
 */
enum LIBCTHREADS_RUNTIME_ERROR
{
	LIBCTHREADS_RUNTIME_ERROR_GENERIC			= 0,
	 ...
	 */
	LIBCTHREADS_RUNTIME_ERROR_FINALIZE_FAILED		= 5,
	 ...
	 */
	LIBCTHREADS_RUNTIME_ERROR_ABORT_REQUESTED		= 15
};

#endif /* !defined( _LIBCTHREADS_ERROR_H ) */
